...
:::
::: proof
$(I - P)x = x - q(q^T x)$, which combines the [[#^dot-product-operation-count|Proposition 1]], [[#^vector-subtraction-operation-count|Proposition 2]] and [[#^scalar-vector-operation-count|Proposition 3]].
:::
